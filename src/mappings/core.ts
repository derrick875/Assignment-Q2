...
import { updateExchangeDayData } from './dayUpdates'
...
export function handleSwap(event: Swap): void {
  ...
  // update day entities
  let exchangeDayData = updateExchangeDayData(uniswap as ExchangeFactory, event)

  // swap specific updating
  exchangeDayData.dailyVolumeUSD = exchangeDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  exchangeDayData.dailyVolumeETH = exchangeDayData.dailyVolumeETH.plus(trackedAmountETH)
  exchangeDayData.dailyVolumeUntracked = exchangeDayData.dailyVolumeUntracked.plus(derivedAmountUSD)
